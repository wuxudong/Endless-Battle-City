...
import com.wupipi.tankwar.TankWarActivity;
...
public class SceneManager {
    private Scene scene;
    private TankWarActivity.ScoreListener scoreListener;
    ...
    public void setScoreListener(TankWarActivity.ScoreListener scoreListener) {
        this.scoreListener = scoreListener;
    }

    public TankWarActivity.ScoreListener getScoreListener() {
