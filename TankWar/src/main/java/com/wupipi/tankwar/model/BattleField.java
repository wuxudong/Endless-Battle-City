...
public class BattleField {
  ...
  public void setWall(int i, int j) {
    Wall wall = new Wall();
    wall.position = new Point(j * Const.OFFSET_PER_TILE, i * Const.OFFSET_PER_TILE);
    tiles[i][j] = wall;
  }

  public void setWallTopChip(int i, int j) {
    WallTopChip topChip = new WallTopChip();
    topChip.position = new Point(j * Const.OFFSET_PER_TILE, i * Const.OFFSET_PER_TILE);
    tiles[i][j] = topChip;
  }

  public void setWallLeftChip(int i, int j) {
    WallLeftChip leftChip = new WallLeftChip();
    leftChip.position = new Point(j * Const.OFFSET_PER_TILE, i * Const.OFFSET_PER_TILE);
    tiles[i][j] = leftChip;
  }

  public void setWallRightChip(int i, int j) {
    WallRightChip rightChip = new WallRightChip();
    rightChip.position = new Point(j * Const.OFFSET_PER_TILE + Const.OFFSET_PER_TILE / 2, i * Const.OFFSET_PER_TILE);
    tiles[i][j] = rightChip;
  }

  public void setWallBottomChip(int i, int j) {
    WallBottomChip bottomChip = new WallBottomChip();
    bottomChip.position = new Point(j * Const.OFFSET_PER_TILE, i * Const.OFFSET_PER_TILE + Const.OFFSET_PER_TILE / 2);
    tiles[i][j] = bottomChip;
  }

  public void setWater(int i, int j) {
    Water water = new Water();
    water.position = new Point(j * Const.OFFSET_PER_TILE, i * Const.OFFSET_PER_TILE);
    tiles[i][j] = water;
  }

  public void setGrid(int i, int j) {
    Grid grid = new Grid();
    grid.position = new Point(j * Const.OFFSET_PER_TILE, i * Const.OFFSET_PER_TILE);
    tiles[i][j] = grid;
  }

  public void setGrass(int i, int j) {
    Grass grass = new Grass();
    grass.position = new Point(j * Const.OFFSET_PER_TILE, i * Const.OFFSET_PER_TILE);
    tiles[i][j] = grass;
  }

  public void setIce(int i, int j) {
    Ice ice = new Ice();
    ice.position = new Point(j * Const.OFFSET_PER_TILE, i * Const.OFFSET_PER_TILE);
    tiles[i][j] = ice;
  }
